...
FROM
    ...
    m_staff ON m_staff.id = t_record_anod.worker_id
        LEFT JOIN
    (SELECT 
        record_anod_id AS idd,
            anod_error_id,
            SUM(ng_quantity) AS ng_quantity,
            SUM(CASE
                WHEN m_anod_error.code = 'A1' THEN t_record_anod_error.ng_quantity
                ELSE 0
            END) AS a1,
            SUM(CASE
                WHEN m_anod_error.code = 'A2' THEN t_record_anod_error.ng_quantity
                ELSE 0
            END) AS a2,
            SUM(CASE
                WHEN m_anod_error.code = 'A3' THEN t_record_anod_error.ng_quantity
                ELSE 0
            END) AS a3,
            SUM(CASE
                WHEN m_anod_error.code = 'A4' THEN t_record_anod_error.ng_quantity
                ELSE 0
            END) AS a4,
            SUM(CASE
                WHEN m_anod_error.code = 'A5' THEN t_record_anod_error.ng_quantity
                ELSE 0
            END) AS a5
    FROM
        t_record_anod_error
