...
try {
    $sql = "INSERT INTO t_record_inspect(machine_id, order_sheet_id, shift_id, product_id, 
    ...
    $stmt = $dbh->getInstance()->prepare("SELECT MAX(t_record_inspect.id) AS id FROM t_record_inspect");
    $stmt->execute();
